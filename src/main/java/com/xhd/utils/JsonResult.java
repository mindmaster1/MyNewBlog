...
public class JsonResult {
    ...
    private static final String DEFUALT_STATUS_KEY = "status";
    ...
    public static JsonData success(){
        return build(DEFUALT_STATUS_KEY,DEFAULT_STATUS_SUCCESS);
    }
    public static JsonData success(Object code){
        return build(DEFUALT_STATUS_KEY,code);
    }
    ...
    public static JsonData fail(){
        return build(DEFUALT_STATUS_KEY,DEFAULT_STATUS_FAIL);
    }
    public static JsonData fail(Object code){
        return build(DEFUALT_STATUS_KEY,code);
    }

    public static JsonData fial(String codeKey,Object code){
        return build(codeKey,code);
    }
    ...
    public static JsonData build(DataMap dataMap){
        ...
        if(dataMap.getCode()!=null){
            jsonData.put(DEFUALT_STATUS_KEY,dataMap.getCode());
        }else{
            if(dataMap.getSuccess()!=null){
                if(dataMap.getSuccess()){
                    jsonData.put(DEFAULT_STATUS_FAIL,DEFAULT_STATUS_SUCCESS);
                }else {
                    jsonData.put(DEFUALT_STATUS_KEY,DEFAULT_STATUS_FAIL);
                }
            }
        }
